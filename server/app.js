...
const app = express();
const rateLimitHelper = require('./bin/rate_limit_helper');
...
// routing
app.use('/api', rateLimitHelper.apiLimit, require('./lib/routes/api_router'));

const clientBuildDir = path.resolve(__dirname, '../client/build');
app.use(rateLimitHelper.clientLimit);
